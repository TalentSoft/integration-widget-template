...
describe('Widget List', () => {
  ...
  afterEach(() => {
    const wrapper = shallow(
      <List showPicture={false} showDetail={false} values={mockedProps} />
    );
  ...
  it('With showPicture = true, Check if urlPicture is null/empty, show default icon', () => {
    const wrapper = shallow(
      <List showPicture={true} showDetail={false} values={mockedProps} />
    );
  ...
  it('With showDetail = true, Check if detail validated is displayed with the right color', () => {
    ...
    const wrapper = shallow(
      <List showPicture={true} showDetail={true} values={mockedProps} />
    );
