    ...
    return (
      <ul className="table-columns" key="colums-key">
        {this.props.columns.map((column, index) => (
          <li key={index} style={{ width: column.width }}>
            {column.name}
          </li>
        ))}
      </ul>
          ...
          switch (item.type) {
            case ValueType.Date: {
              return (
                <li
                  className="dates"
                  style={{ width: this.props.columns[ind].width }}
            ...
            case ValueType.Tag: {
              return (
                <li
                  ...
                  key={item.value.toString() + index}
                >
                  <span className="Hylia-a-tag Hylia-a-tag--apprentice">
                    {item.value}
                  </span>
                </li>
              );
