...
describe('Widget Table', () => {
  ...
  it('Table has the good amount of columns', () => {
    const wrapper = shallow(
      <Table columns={mockedColumns} values={mockedLine} />
    );
  ...
  it('Check Tag type has the good css class', () => {
    ...
    expect(
      wrapper
        ...
        .find('li')
        .find('span')
        .hasClass('Hylia-a-tag Hylia-a-tag--apprentice')
    ).toBe(true);
  });
  ...
  it('Check Date type has the good css class', () => {
    ...
    expect(wrapper.find('.table-line').find('li').at(2).hasClass('dates')).toBe(
      true
    );
  });
  ...
  it('Check Text type has the good css class', () => {
    ...
    expect(wrapper.find('.table-line').find('li').at(1).hasClass('text')).toBe(
      true
    );
  });
